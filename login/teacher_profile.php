          ...
          <div class="tab-content">
            <div class="tab-pane active" id="my-account">
              <div class="tile user-settings">
                ...
                <div id="teacher_update_profile_status"></div>
                <?php require ('form/teacher_update_profile_form.php') ?>
              </div>
            </div>
            <div class="tab-pane fade" id="change-pass">
              <div class="tile user-settings">
                <h4 class="line-head">Change Password</h4>
                <div id="teacher_update_password_status"></div>
                <?php require ('form/teacher_update_password_form.php') ?>
              </div>
            </div>
          </div>
        </div>
