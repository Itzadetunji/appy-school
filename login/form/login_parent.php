<form autocomplete="off" class="login-form" method="post" action="api/login_query?login=parent" required>
  <h3 class="login-head"><i class="fa fa-lg fa-fw fa-user"></i>PARENT SIGN IN</h3>
