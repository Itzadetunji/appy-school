    ...
    <main class="app-content">
      ...
      <?php
        ...
        switch ($get_class) {
          case 'JSS1':
            ?>
              <img src="../media/image/timetable/teacher/JSS1_timetable.jpg" class="timetable_images" alt="student_timetable">
            <?php
            break;

          case 'JSS2':
            ?>
              <img src="../media/image/timetable/teacher/JSS2_timetable.jpg" class="timetable_images" alt="student_timetable">
            <?php
            break;

          case 'JSS3':
            ?>
              <img src="../media/image/timetable/teacher/JSS3_timetable.jpg" class="timetable_images" alt="student_timetable">
            <?php
            break;

          case 'SSS1':
            ?>
              <img src="../media/image/timetable/teacher/SSS1_timetable.jpg" class="timetable_images" alt="student_timetable">
            <?php
            break;

          case 'SSS2':
            ?>
              <img src="../media/image/timetable/teacher/SSS2_timetable.jpg" class="timetable_images" alt="student_timetable">
            <?php
            break;

          case 'SSS3':
            ?>
              <img src="../media/image/timetable/teacher/SSS3_timetable.jpg" class="timetable_images" alt="student_timetable">
            <?php
            break;
        ...
        if ($get_class == "JSS1" || $get_class == "JSS2" || $get_class == "JSS3" || $get_class == "SSS1" || $get_class == "SSS2" || $get_class == "SSS3") {
          ?>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="click_effect">
                  <a href="../media/image/timetable/teacher/<?php echo $get_class; ?>_timetable.jpg" download="">
              ...
              <!-- <div class="col-md-6">
                <div class="click_effect">
                  <a href="">
                    <div class="widget-small primary"><i class="icon fa fa-eye fa-3x"></i>
                      <div class="info"><h4>View</h4></div>
                    </div>
                  </a>
                </div>
              </div> -->
